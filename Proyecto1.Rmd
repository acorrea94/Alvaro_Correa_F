...
## asÃ­ se reducen datos (atributos) no relevantes dentro de la data

sandwich<-sanguche %>% select(Direccion,Precio,Ingredientes,nota)

## se procede a obtener informaciÃ³n a partir de los datos que poseemos y separamos las columnas para
...
##Luego hay que diferenciar Â¿Cuantos de estos sandwiches con buenas notas son del extranjero?
##Â¿SerÃ¡ necesario incluir sandwiches del extranjero cuando quizas en nuestro paÃ­s no existen
## dichos ingredientes? Para esto se filtra a travÃ©s del Precio (USD,AUD,NZD) para observar que es lo
...
## De aqui se concluye que de los 88 sandwiches que tenemos con nota mÃ¡xima, solo 3 son de Estados Unidos
## y 5 pertenecen a Oceania (Australia y Nueva Zelanda) , por lo que luego de observar la data disponible
## se determina que no son influyentes en el resultado del anÃ¡lisis.
...
##vacias (NA) y por lo que luego se eliminaran las celdas vacias y entonces serÃ¡n eliminadas como se establecio
...
## Se procede a realizar una matriz de comparaciÃ³n para establecer cuantas veces
##se repite cada ingrediente en el total de nuestros 80 mejores sandwiches, para asi quizas
##lograr entender cual podrÃ¬a ser nuestra receta perfecta
